...
import static com.example.common.config.ProjectConstant.*;
// import static com.example.config.ProjectConstant.MAPPER_INTERFACE_REFERENCE;
...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/demopmsd?useUnicode=true&characterEncoding=utf8";
     ...
     * 项目基础包名称
     */
    private static final String BASE_PACKAGE_PATH = "/com/example";
    private static final String BASE_PACKAGE_ABSOLUTE_PATH = PROJECT_PATH + JAVA_PATH + "/com/example";
...
//         genCodeByCustomModelName("dict_lab_item", "dict", "LabItem");
//         genCodeByCustomModelName("sys_role", "uc", "Role");
        genCodeByCustomModelName("drug_case", "patient", "DrugCase");
        genCodeByCustomModelName("decision_rule", "patient", "DecisionRule");
        genCodeByCustomModelName("decision_proc", "patient", "DecisionProc");
        // genCodeByCustomModelNameAndTemplate("hdict_drug", "his", "HisDictDrug","simpleDict");
    }
    ...
    public static void genService(String tableName, String moduleName, String modelName, String templateFolder) {
        try {
            ...
            File file = new File(BASE_PACKAGE_ABSOLUTE_PATH + "/modules/" + moduleName + "/service/" + modelNameUpperCamel + "Service.java");
            ...
            File file1 = new File(BASE_PACKAGE_ABSOLUTE_PATH + "/modules/" + moduleName + "/service/impl/" + modelNameUpperCamel + "ServiceImpl.java");
    ...
    private static freemarker.template.Configuration getConfiguration(String templateFileFolder) throws IOException {
        freemarker.template.Configuration cfg = new freemarker.template.Configuration(freemarker.template
                .Configuration
                .VERSION_2_3_23);
        cfg.setDirectoryForTemplateLoading(new File(TEMPLATE_FILE_PATH + "/" + templateFileFolder));
